...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">編輯用戶: {{ $user->name }}</h1>
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700 mb-1">密碼 (留空表示不修改)</label>
                                <input type="password" name="password" id="password" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 mb-2">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="google_analytics_view_id" id="google_analytics_view_id" value="{{ old('google_analytics_view_id', $user->google_analytics_view_id) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label for="google_ads_customer_id" class="block text-sm font-medium text-gray-700 mb-1">Google Ads Customer ID</label>
                                <input type="text" name="google_ads_customer_id" id="google_ads_customer_id" value="{{ old('google_ads_customer_id', $user->google_ads_customer_id) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="google_search_console_site_url" id="google_search_console_site_url" value="{{ old('google_search_console_site_url', $user->google_search_console_site_url) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                    </div>

                    <div class="flex justify-end">
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">更新用戶</button>
                    </div>
                </form>
            </div>
        </div>
